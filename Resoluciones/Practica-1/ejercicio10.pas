{10. Un local de ropa desea analizar las ventas realizadas en el último mes. Para ello se lee por cada día
...
var
    ...
    cantVentas, max, i, diaMax: integer;
begin
    max:= -1;
    montoTotal:= 0;
    for i:= 1 to 5 do // Seria 31
        begin
            cantVentas:= 0;
            montoDia:= 0;
